...
export default async function PublicLayout({
  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden px-3 py-3 sm:px-5 sm:py-5 lg:px-7 lg:py-7 xl:px-8 xl:py-8">
      ...
      />
      <div className="glass-panel glass-glow relative mt-2.5 flex w-full min-h-0 flex-1 rounded-[1.5rem] p-2.5 sm:mt-3.5 sm:rounded-[2rem] sm:p-4 lg:p-5">
        <div className="mx-auto flex w-full min-h-0 flex-1 flex-col 2xl:max-w-[1700px]">
